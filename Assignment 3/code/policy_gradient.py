...
class PolicyGradient(object):
    ...
    def init_policy(self):
        ...
        if self.discrete:
            ...
            self.policy = GaussianPolicy(network, action_dim=self.action_dim)
    ...
    def get_returns(self, paths):
        ...
        for path in paths:
            ...
            for t in range(len(rewards)-1, -1, -1):
                running_returns = rewards[t]+self.config.gamma*running_returns
                return_path.append(running_returns)
            return_path.reverse()
            #######################################################
            #########          END YOUR CODE.          ############
